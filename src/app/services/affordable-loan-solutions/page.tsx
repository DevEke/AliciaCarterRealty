            ...
            <div className="contentGridThreeColumn">
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="owner occupied focus icon" src={owner.src}/>
              ...
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="flexible buyer eligibility icon" src={buyer.src}/>
              ...
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="alternative qualification options icon" src={options.src}/>
              ...
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="reduced upfront costs icon" src={upfront.src}/>
              ...
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="mortgage insurance considerations icon" src={mortgage.src}/>
              ...
              <Reveal>
                <div className="gridItemCenterAligned">
                  <img className="gridItemImage" height={72} width={72} alt="education requirements icon" src={educate.src}/>
        ...
        <section className="section actionBackground">
          <Reveal>
            <div className="container containerFlex contentPad actionFlex">
              ...
              <CallToActionButton reason="affordable-loan-solutions" />
            </div>
          </Reveal>
        </section>
      </div>
