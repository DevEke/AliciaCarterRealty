                    ...
                    <div className="contentGridTwoColumn">
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="pay bills on time icon" src={bills.src}/>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="keep balances low icon" src={balances.src}/>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="review credit report icon" src={review.src}/>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="avoid closing credit cards icon" src={cards.src}/>
            ...
            <section className="section actionBackground">
                <Reveal>
                    <div className="container containerFlex contentPad actionFlex">
                        ...
                        <CallToActionButton reason="credit-readiness"/>
                    </div>
                </Reveal>
            </section>
        </div>
