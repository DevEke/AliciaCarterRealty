                    ...
                    <div className="contentGridTwoColumn">
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="grants icon" src={grants.src}/>
                                <h3>Grants</h3>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="deferred loans icon" src={deferred.src}/>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="low interest loans icon" src={interest.src}/>
                        ...
                        <Reveal>
                            <div className="gridItemLeftAligned">
                                <img className="gridItemImage" height={72} width={72} alt="forgivable loans icon" src={forgive.src}/>
            ...
            <section className="section actionBackground">
                <Reveal>
                    <div className="container containerFlex contentPad actionFlex">
                        ...
                        <CallToActionButton reason="down-payment-assistance"/>
                    </div>
                </Reveal>
            </section>
        </div>
